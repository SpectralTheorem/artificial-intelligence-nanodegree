    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                successorState = (
                        nextPos,
                        True if nextPos == self.corners[0] else state[1],
                        True if nextPos == self.corners[1] else state[2],
                        True if nextPos == self.corners[2] else state[3],
                        True if nextPos == self.corners[3] else state[4])
